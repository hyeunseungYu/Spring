//package mySelectShopBeta.util;
//
//
//import lombok.RequiredArgsConstructor;
//import mySelectShopBeta.Dto.ProductRequestDto;
//import mySelectShopBeta.controller.ProductController;
...
//import mySelectShopBeta.repository.UserRepository;
...
//        // 네이버 쇼핑 API 통해 상품 검색
//        List<ProductRequestDto> productRequestDtoList = naverApiService.searchItems(searchWord).stream().map(ProductRequestDto::new).collect(Collectors.toList());
//
